    ...
    <section class="home">
        <div class="container">
            <div class="wrapper flex gap-[38px]">
                ...
                <div
                    class="home-basic w-[150px] lg:w-[889px] h-[100px] lg:h-[300px] flex justify-end items-end   gap-[25px] text-[#E8E8E8] text-[20px] font-semibold bg-green-500 rounded-[23px] py-[20px] px-[15px]">
