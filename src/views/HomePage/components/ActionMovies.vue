<template>
    <section class="trending mt-[37px] w-[907px]">
        ...
        <div class="wrapper flex justify-between items-center">
            ...
            <h2 class="text-[25px] font-semibold text-white ">Action</h2>
...
const fetchData = async () => {
    try {
        const response = await axios.get('https://api.themoviedb.org/3/search/movie?api_key=02708c4929ad93aa5e68f8ee7bfa4445&query=action');
